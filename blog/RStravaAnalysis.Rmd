...
With a slightly more complex model we could use these proxies to track a measure of fitness over time, similar to VO~2~ max estimates provided by popular sports apps. 
